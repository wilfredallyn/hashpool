...
use const_sv2::{
    CHANNEL_BIT_ALLOCATE_MINING_JOB_TOKEN, CHANNEL_BIT_ALLOCATE_MINING_JOB_TOKEN_SUCCESS, CHANNEL_BIT_CHANNEL_ENDPOINT_CHANGED, CHANNEL_BIT_CLOSE_CHANNEL, CHANNEL_BIT_COINBASE_OUTPUT_DATA_SIZE, CHANNEL_BIT_DECLARE_MINING_JOB, CHANNEL_BIT_DECLARE_MINING_JOB_ERROR, CHANNEL_BIT_DECLARE_MINING_JOB_SUCCESS, CHANNEL_BIT_IDENTIFY_TRANSACTIONS, CHANNEL_BIT_IDENTIFY_TRANSACTIONS_SUCCESS, CHANNEL_BIT_MINING_SET_NEW_PREV_HASH, CHANNEL_BIT_NEW_EXTENDED_MINING_JOB, CHANNEL_BIT_NEW_MINING_JOB, CHANNEL_BIT_NEW_TEMPLATE, CHANNEL_BIT_OPEN_EXTENDED_MINING_CHANNEL, CHANNEL_BIT_OPEN_EXTENDED_MINING_CHANNEL_SUCCES, CHANNEL_BIT_OPEN_MINING_CHANNEL_ERROR, CHANNEL_BIT_OPEN_STANDARD_MINING_CHANNEL, CHANNEL_BIT_OPEN_STANDARD_MINING_CHANNEL_SUCCESS, CHANNEL_BIT_PROVIDE_MISSING_TRANSACTIONS, CHANNEL_BIT_PROVIDE_MISSING_TRANSACTIONS_SUCCESS, CHANNEL_BIT_RECONNECT, CHANNEL_BIT_REQUEST_TRANSACTION_DATA, CHANNEL_BIT_REQUEST_TRANSACTION_DATA_ERROR, CHANNEL_BIT_REQUEST_TRANSACTION_DATA_SUCCESS, CHANNEL_BIT_SETUP_CONNECTION, CHANNEL_BIT_SETUP_CONNECTION_ERROR, CHANNEL_BIT_SETUP_CONNECTION_MINT, CHANNEL_BIT_SETUP_CONNECTION_SUCCESS, CHANNEL_BIT_SETUP_CONNECTION_SUCCESS_MINT, CHANNEL_BIT_SET_CUSTOM_MINING_JOB, CHANNEL_BIT_SET_CUSTOM_MINING_JOB_ERROR, CHANNEL_BIT_SET_CUSTOM_MINING_JOB_SUCCESS, CHANNEL_BIT_SET_EXTRANONCE_PREFIX, CHANNEL_BIT_SET_GROUP_CHANNEL, CHANNEL_BIT_SET_NEW_PREV_HASH, CHANNEL_BIT_SET_TARGET, CHANNEL_BIT_SUBMIT_SHARES_ERROR, CHANNEL_BIT_SUBMIT_SHARES_EXTENDED, CHANNEL_BIT_SUBMIT_SHARES_STANDARD, CHANNEL_BIT_SUBMIT_SHARES_SUCCESS, CHANNEL_BIT_SUBMIT_SOLUTION, CHANNEL_BIT_SUBMIT_SOLUTION_JD, CHANNEL_BIT_UPDATE_CHANNEL, CHANNEL_BIT_UPDATE_CHANNEL_ERROR, MESSAGE_TYPE_ALLOCATE_MINING_JOB_TOKEN, MESSAGE_TYPE_ALLOCATE_MINING_JOB_TOKEN_SUCCESS, MESSAGE_TYPE_CHANNEL_ENDPOINT_CHANGED, MESSAGE_TYPE_CLOSE_CHANNEL, MESSAGE_TYPE_COINBASE_OUTPUT_DATA_SIZE, MESSAGE_TYPE_DECLARE_MINING_JOB, MESSAGE_TYPE_DECLARE_MINING_JOB_ERROR, MESSAGE_TYPE_DECLARE_MINING_JOB_SUCCESS, MESSAGE_TYPE_IDENTIFY_TRANSACTIONS, MESSAGE_TYPE_IDENTIFY_TRANSACTIONS_SUCCESS, MESSAGE_TYPE_MINING_SET_NEW_PREV_HASH, MESSAGE_TYPE_NEW_EXTENDED_MINING_JOB, MESSAGE_TYPE_NEW_MINING_JOB, MESSAGE_TYPE_NEW_TEMPLATE, MESSAGE_TYPE_OPEN_EXTENDED_MINING_CHANNEL, MESSAGE_TYPE_OPEN_EXTENDED_MINING_CHANNEL_SUCCES, MESSAGE_TYPE_OPEN_MINING_CHANNEL_ERROR, MESSAGE_TYPE_OPEN_STANDARD_MINING_CHANNEL, MESSAGE_TYPE_OPEN_STANDARD_MINING_CHANNEL_SUCCESS, MESSAGE_TYPE_PROVIDE_MISSING_TRANSACTIONS, MESSAGE_TYPE_PROVIDE_MISSING_TRANSACTIONS_SUCCESS, MESSAGE_TYPE_RECONNECT, MESSAGE_TYPE_REQUEST_TRANSACTION_DATA, MESSAGE_TYPE_REQUEST_TRANSACTION_DATA_ERROR, MESSAGE_TYPE_REQUEST_TRANSACTION_DATA_SUCCESS, MESSAGE_TYPE_SETUP_CONNECTION, MESSAGE_TYPE_SETUP_CONNECTION_ERROR, MESSAGE_TYPE_SETUP_CONNECTION_MINT, MESSAGE_TYPE_SETUP_CONNECTION_SUCCESS, MESSAGE_TYPE_SETUP_CONNECTION_SUCCESS_MINT, MESSAGE_TYPE_SET_CUSTOM_MINING_JOB, MESSAGE_TYPE_SET_CUSTOM_MINING_JOB_ERROR, MESSAGE_TYPE_SET_CUSTOM_MINING_JOB_SUCCESS, MESSAGE_TYPE_SET_EXTRANONCE_PREFIX, MESSAGE_TYPE_SET_GROUP_CHANNEL, MESSAGE_TYPE_SET_NEW_PREV_HASH, MESSAGE_TYPE_SET_TARGET, MESSAGE_TYPE_SUBMIT_SHARES_ERROR, MESSAGE_TYPE_SUBMIT_SHARES_EXTENDED, MESSAGE_TYPE_SUBMIT_SHARES_STANDARD, MESSAGE_TYPE_SUBMIT_SHARES_SUCCESS, MESSAGE_TYPE_SUBMIT_SOLUTION, MESSAGE_TYPE_SUBMIT_SOLUTION_JD, MESSAGE_TYPE_UPDATE_CHANNEL, MESSAGE_TYPE_UPDATE_CHANNEL_ERROR
};

use common_messages_sv2::{
    ChannelEndpointChanged, SetupConnection, SetupConnectionError, SetupConnectionMint, SetupConnectionSuccess, SetupConnectionSuccessMint
};
...
pub enum CommonMessages<'a> {
    ...
    #[cfg_attr(feature = "with_serde", serde(borrow))]
    SetupConnectionMint(SetupConnectionMint<'a>),
    #[cfg_attr(feature = "with_serde", serde(borrow))]
...
impl<'a> IsSv2Message for CommonMessages<'a> {
    fn message_type(&self) -> u8 {
        match self {
            ...
            Self::SetupConnectionMint(_) => MESSAGE_TYPE_SETUP_CONNECTION_MINT,
    ...
    fn channel_bit(&self) -> bool {
        match self {
            ...
            Self::SetupConnectionMint(_) => CHANNEL_BIT_SETUP_CONNECTION_MINT,
...
impl<'decoder> From<CommonMessages<'decoder>> for EncodableField<'decoder> {
    fn from(m: CommonMessages<'decoder>) -> Self {
        match m {
            ...
            CommonMessages::SetupConnectionMint(a) => a.into(),
...
impl GetSize for CommonMessages<'_> {
    fn get_size(&self) -> usize {
        match self {
            ...
            CommonMessages::SetupConnectionMint(a) => a.get_size(),
...
pub enum CommonMessageTypes {
    ...
    SetupConnectionMint = MESSAGE_TYPE_SETUP_CONNECTION_MINT,
    SetupConnectionSuccess = MESSAGE_TYPE_SETUP_CONNECTION_SUCCESS,
    SetupConnectionSuccessMint = MESSAGE_TYPE_SETUP_CONNECTION_SUCCESS_MINT,
...
impl TryFrom<u8> for CommonMessageTypes {
    ...
    fn try_from(v: u8) -> Result<CommonMessageTypes, Error> {
        match v {
            ...
            MESSAGE_TYPE_SETUP_CONNECTION_MINT => Ok(CommonMessageTypes::SetupConnectionMint),
            MESSAGE_TYPE_SETUP_CONNECTION_SUCCESS => Ok(CommonMessageTypes::SetupConnectionSuccess),
            MESSAGE_TYPE_SETUP_CONNECTION_SUCCESS_MINT => Ok(CommonMessageTypes::SetupConnectionSuccessMint),
...
impl<'a> TryFrom<(u8, &'a mut [u8])> for CommonMessages<'a> {
    ...
    fn try_from(v: (u8, &'a mut [u8])) -> Result<Self, Self::Error> {
        ...
        match msg_type {
            ...
            CommonMessageTypes::SetupConnectionMint => {
                let message: SetupConnectionMint<'a> = from_bytes(v.1)?;
                Ok(CommonMessages::SetupConnectionMint(message))
            }
            ...
            CommonMessageTypes::SetupConnectionSuccessMint => {
                let message: SetupConnectionSuccessMint = from_bytes(v.1)?;
                Ok(CommonMessages::SetupConnectionSuccessMint(message))
            }
...
impl<'a> From<SetupConnectionMint<'a>> for CommonMessages<'a> {
    fn from(v: SetupConnectionMint<'a>) -> Self {
        CommonMessages::SetupConnectionMint(v)
    }
}
...
impl<'a> From<SetupConnectionSuccessMint> for CommonMessages<'a> {
    fn from(v: SetupConnectionSuccessMint) -> Self {
        CommonMessages::SetupConnectionSuccessMint(v)
    }
}
